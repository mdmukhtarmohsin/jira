      ...
      <div className="flex items-center space-x-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            Set up your sprint details and select tasks from the backlog
          </p>
        </div>
      </div>
        ...
        <div className="lg:col-span-2 space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Define the basic parameters for your sprint
              </CardDescription>
            </CardHeader>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Choose tasks from your backlog to include in this sprint
              </CardDescription>
            </CardHeader>
            <CardContent>
              {backlogTasks.length > 0 ? (
                ...
                <div className="text-center py-8">
                  <p className="text-muted-foreground">
                    No tasks available in the backlog for this team.
                  </p>
            ...
            <CardContent>
              <div className="space-y-3">
                ...
                <div className="flex justify-between">
                  ...
                  <p className="text-2xl font-bold">{selectedStoryPoints}</p>
                </div>
                <div className="flex justify-between">
                  <span className="text-sm text-muted-foreground">
                    Sprint Duration
                  </span>
                  <p className="text-2xl font-bold">{sprintDuration} days</p>
                </div>
                <div className="flex justify-between">
                  <span className="text-sm text-muted-foreground">
                  ...
                  <span className="font-medium">
                    {totalCapacity
                      ? Math.round((selectedStoryPoints / totalCapacity) * 100)
                      : 0}
                    %
                  </span>
                </div>
