...
import { Plus, Users, Calendar, Target, MoreHorizontal, RefreshCw, AlertTriangle } from "lucide-react"
...
export default function TeamsPage() {
      ...
      <div className="space-y-6">
        ...
        <Card className="border-red-200 bg-red-50">
          <CardContent className="flex flex-col items-center justify-center py-12">
            ...
            <h3 className="text-lg font-medium text-red-900 mb-2">Error Loading Teams</h3>
  ...
  return (
    <div className="space-y-6">
        ...
        <Card className="border-dashed border-2 border-gray-300">
          <CardContent className="flex flex-col items-center justify-center py-12">
            ...
            <p className="text-gray-600 text-center mb-6 max-w-md">
              Create your first team to start organizing projects and collaborating with team members.
            </p>
            <Button onClick={() => setShowCreateModal(true)}>
              <Plus className="mr-2 h-4 w-4" />
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-3 gap-4 text-center">
                  ...
                  <div>
                    ...
                    <p className="text-2xl font-bold text-gray-900">{team.activeSprintCount}</p>
                  ...
                  <div>
                    ...
                    <p className="text-2xl font-bold text-gray-900">{team.completedTasksThisMonth}</p>
                ...
                {team.currentSprint && (
                  <div>
                    <h4 className="font-medium text-gray-900 mb-2">Current Sprint</h4>
                    <div className="space-y-2">
                      <div className="flex items-center justify-between">
                        <span className="text-sm text-gray-600">{team.currentSprint}</span>
                        <Badge variant={team.sprintProgress === 100 ? "default" : "secondary"}>
                          {team.sprintProgress}%
                        </Badge>
                      </div>
          ...
          <Card className="border-dashed border-2 border-gray-300 hover:border-gray-400 transition-colors">
            <CardContent className="flex flex-col items-center justify-center py-12">
              ...
              <p className="text-gray-600 text-center mb-4">
                Start collaborating with a new team. Add members and begin your first sprint.
              </p>
      ...
      <CreateTeamModal open={showCreateModal} onOpenChange={setShowCreateModal} onTeamCreated={handleTeamCreated} />
    </div>
  )
}
