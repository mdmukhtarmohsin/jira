...
import { Plus, Calendar, Users, Sparkles, RefreshCw, AlertTriangle } from "lucide-react"
...
export default function SprintPlanningPage() {
  ...
  const { teams, selectedTeamId, setSelectedTeamId, backlogTasks, teamMembers, loading, error, createSprint, refetch } =
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600">Plan and manage your sprints with AI-powered insights</p>
          </div>
        </div>
        ...
        <div className="flex items-center justify-center py-12">
          <div className="text-center">
            ...
            <p className="mt-2 text-gray-600">Loading sprint planning data...</p>
          </div>
        </div>
      </div>
    )
      ...
      <div className="space-y-6">
        ...
        <Card className="border-red-200 bg-red-50">
          <CardContent className="flex flex-col items-center justify-center py-12">
            ...
            <h3 className="text-lg font-medium text-red-900 mb-2">Error Loading Sprint Planning</h3>
  ...
  if (teams.length === 0) {
    return (
      <div className="space-y-6">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Sprint Planning</h1>
          <p className="text-gray-600">Create a team first to start planning sprints</p>
        </div>
