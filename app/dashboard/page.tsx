...
import { BarChart3, Calendar, CheckCircle, Clock, AlertTriangle, RefreshCw, Plus } from "lucide-react"
  ...
  if (stats && stats.activeSprints === 0 && sprints.length === 0) {
    return (
      <div className="space-y-6">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Dashboard</h1>
          <p className="text-gray-600">Welcome! Let's get you started with your first project.</p>
        </div>
        ...
        <Card className="border-dashed border-2 border-gray-300">
          <CardContent className="flex flex-col items-center justify-center py-12">
            ...
            <p className="text-gray-600 text-center mb-6 max-w-md">
              Create your first team and start managing projects with AI-powered sprint planning.
            </p>
            <div className="flex space-x-3">
              <Link href="/dashboard/teams">
                <Button>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Current sprint status across all teams</CardDescription>
          </CardHeader>
                ...
                <div key={sprint.id} className="space-y-2">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">{sprint.team_name}</p>
                    </div>
                    <div className="flex items-center space-x-2">
                      <Badge variant={sprint.progress === 100 ? "default" : "secondary"}>{sprint.status}</Badge>
                  ...
                  <div className="flex justify-between text-xs text-gray-500">
                    ...
                    <span>Due: {new Date(sprint.end_date).toLocaleDateString()}</span>
                  </div>
                </div>
              ))
            ) : (
